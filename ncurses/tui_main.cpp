...
int main(int argc, char* argv[]) {
    ...
    text_edit_win = TextEditView::create(
        text_edit_win_size,
        text_edit_win_pos,
        TextW(L"test", Align::Center, COLOR_PAIR(nu::Cyan)), 3
    );
    ...
    // work_mode_options_menu_win->add_menu_item(current_pool["work_mode_options_menu"]["exit"], L"", work_mode_options_menu_exit_callback, { KEY_ENTER });
    ...
    // language_options_menu_win->add_menu_item(current_pool["language_options_menu"]["exit"], L"", language_options_menu_exit_callback, { KEY_ENTER });
